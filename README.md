...
* **Task 4** --- *Lexicon handling.* Set up an `absl::flat_hash_set` object with the large lexicon, read from our data file. There’s a utility function called `word_ladder::read_lexicon` that will read it in from a file for you.
